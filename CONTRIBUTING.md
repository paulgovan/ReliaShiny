...
This outlines how to propose a change to ReliaShiny. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("paulgovan/WeibullR.shiny", fork = TRUE)`.
...
Code of
Conduct](https://paulgovan.github.io/ReliaShiny/CODE_OF_CONDUCT.md). By

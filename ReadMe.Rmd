...
For demonstration, we'll use the "Time-to-Failure" dataset. First, download the dataset from the Landing page. Then, use the Data Input option in the Data tab to upload it to the app.
...
Next, navigate to the Modeling tab to build your Weibull model. The app will generate a Probability Plot using default settings. Feel free to experiment with different configurations to tailor the model to your needs.

Below the plot, you’ll find additional settings for further customization.
